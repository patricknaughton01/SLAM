...
def correct_pose(pose, trafo):
    ...
    xy = apply_transform(trafo, pose)
    
    # Get new angle by taking arctan of sin divided by cos
    # of angle
    new_heading = pose[2] + atan2(trafo[2], trafo[1])

    return (xy[0], xy[1], new_heading)  # Replace this by the corrected pose.
